...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?= site_url('/assets/images/bird.svg');?>">
                ...
                <div class=''>
                    ...
                    <div class='tweet_box tweet_add'>
                        <div class='left-tweet ml-3'>
                            <!-- PROFILE-IMAGE -->
                            <img class="mr-3" src="<?php echo site_url().$user->profileImage; ?>" style="width: 53px;height:53px;border-radius:50%;" />
                        </div>
                        ...
                        <div class='tweet_body'>
                            <?= form_open_multipart('tweet/submit') ?>
